  ...
  return (
    <div>
      <div className="sm:flex sm:justify-center sm:items-center md:block">
        <div className="grid text-center  md:grid-cols-7 md:gap-8 sm:gap-12 text-2xl md:w-full sm:w-auto justify-center">
        ...
        <div className="text-center grid  md:grid-cols-7 md:gap-8 sm:gap-12 text-2xl md:w-full sm:w-auto  justify-center">
          <div className="font-bold">{index + 1}</div>
          <div className="font-bold">{buyer?.name}</div>
          <div className="text-sm md:block sm:hidden ">{buyer?.address}</div>
          <div className="text-sm md:hidden sm:block ">{buyer?.address.substring(0,50)}...</div>
        
          <div className="text-2xl text-customWhite bg-slate-100 h-[40px] bg-opacity-30 rounded-xl">
            {
              <Select
                bordered={false}
              ...
              <div className="flex flex-col gap-4 justify-between">
                ...
                <div className="flex items-center justify-between">
                  <p className="text-green-600 text-xl font-semibold">
                    <Formateprice price={p.price*p.quantity} />
                  </p>
